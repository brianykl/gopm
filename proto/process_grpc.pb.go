...
func (c *processManagerClient) StartProcess(ctx context.Context, in *StartRequest, opts ...grpc.CallOption) (*ProcessResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessManager_StartProcess_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processManagerClient) StopProcess(ctx context.Context, in *StopRequest, opts ...grpc.CallOption) (*ProcessResponse, error) {
	out := new(ProcessResponse)
	err := c.cc.Invoke(ctx, ProcessManager_StopProcess_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processManagerClient) ListProcess(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessManager_ListProcess_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
